...
import {Grid,Tabs,Tab,Grow,Card,CardActionArea,CardMedia,CardContent,Typography,Dialog,DialogTitle,DialogContent,DialogActions} from '@mui/material'
...
export const Portfolio=()=>{
   ...
   return(
      <Grid container className='section pb_45 pt_45'>
            ...
            {/* dialog */}
            <Dialog open={projectDialog} onClose={()=>setProjectDialog(false)} className='projectDialog' maxWidth="lg">
